...
def load_vector(fname):
    ...
    for line in fin:
        ...
        data[token[0]] = list(map(float, tokens[1:]))
        
    return data

def sentence_to_vec(s, embedding_dict, stop_words, tokenizer):
    """
    Given a sentece and other information ,
    this function returns embedding fkor the whole sentece
    :param s: sentence, string
    :param embedding_dict: dictionary word:vector
    :param stop_words: list of stop words, if any
    :param tokenization function
    """
...
if __name__ == "__main__":
    ...
    embeddings = load_vector("../input/crawl-300d-2M.vec")
